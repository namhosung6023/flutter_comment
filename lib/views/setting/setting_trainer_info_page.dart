...
/// 트레이너 정보 수정 페이지
class SettingTrainerInfoPage extends StatefulWidget {
  @override
  _SettingTrainerInfoPageState createState() => _SettingTrainerInfoPageState();
}

class _SettingTrainerInfoPageState extends State<SettingTrainerInfoPage> {
  String _mode;
      ...
      children: [
        ...
        InkWell(
          ...
          child: Text(
            ...
            style: TextStyle(
              color: _mode == _modeView ? CommonUtils.getColorByHex('#FF2F2F') : CommonUtils.getColorByHex('#4781EC'),
              fontSize: 16.0,
            ),
          ),
        ),
      ...
      children: [
        SizedBox(
          ...
          child: Text(
            title,
            style: TextStyle(
              color: CommonUtils.getColorByHex('#4781EC'),
          ...
          Row(
            ...
            children: [
              ...
              Switch(
                value: value,
                onChanged: onChanged,
                activeColor: CommonUtils.getColorByHex('#4781EC'),
