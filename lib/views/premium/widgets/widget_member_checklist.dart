...
class _MemberChecklistState extends State<MemberChecklist> {
  ...
  Widget _buildTrainerComment() {
    final profile = ClipOval(
      child: Image.asset('assets/img_sample.png',
  ...
  ///
  Widget _buildChecklistItem(checklist) {
    final color =
        (checklist.isEditable) ? CommonUtils.getPrimaryColor() : Colors.black54;
        ...
        Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: Image.asset('assets/ic_dumbbell.png',
                  width: 32.0, fit: BoxFit.cover),
            ),
